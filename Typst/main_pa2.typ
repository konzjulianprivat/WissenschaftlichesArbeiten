...
// #acrfpl("LLM") sind generative Sprachmodelle, die aus einer unstrukturierten Modelleingabe anhand von Wahrscheinlichkeiten eine natürliche Ausgabe produzieren
//   #cite(<Zhao2023>, supplement: "S. 2"). 
